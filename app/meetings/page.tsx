...
export default function MeetingsPage() {
  // You can move this to Supabase later, but here is a hardcoded starter set:
  const schedule = [
    { 
      name: "Recovery Path", 
      time: "10:00 AM", 
    ...
    <main className="max-w-4xl mx-auto p-6 space-y-8 min-h-screen bg-[#001E41] pb-24 text-white">
      ...
      <div className="bg-gradient-to-r from-blue-600/20 to-transparent border-l-4 border-orange-500 p-6 rounded-r-[2rem]">
        <div className="flex items-center gap-3 mb-1">
          ...
          <h2 className="text-lg font-black italic uppercase">Today's Schedule</h2>
        </div>
        <p className="text-blue-100/60 text-xs font-medium uppercase tracking-widest">OKC Helping Hands Daily Calendar</p>
      </div>
